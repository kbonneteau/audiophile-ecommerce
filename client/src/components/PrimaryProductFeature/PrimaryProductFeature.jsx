  ...
  return (
    <article className="primary-feature">
      <div className="primary-feature__image-container">
        <img
          src="http://localhost:8080/images/home/pattern-circles.svg"
          alt=""
          className="primary-feature__circles"
        />
        {/* Refactor for picture */}
        <img
          className="primary-feature__image"
      ...
      <div className="primary-feature__content-container">
        ...
        <Link
          className="primary-feature__product-link"
